...
for folder_name in files.keys():
    ...
    for dosage in new_files[folder_name]:
        ...
        # Load Data
        time, signal, seis1, seis2, phono1, phono2 = hb.load_file_data( files = new_files, 
                                                                        folder_name = folder_name, 
                                                                        dosage = dosage, 
                                                                        file_number = 1,
                                                                        interval_number = 1, 
        ...
        composite_peaks.get_N_composite_signal_dataset(10, 5, display = False, dosage = dosage)
