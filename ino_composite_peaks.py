    ...
    def get_N_composite_signal_dataset(self, N, slide_step_size, display = False, dosage = None):
        ...
        for start, end in composite_endpoints:
            ...
            if display:
                ...
                if dosage is None:
                    plt.suptitle(str(count) + " of " + str(len(composite_endpoints)) + " INO Composites given " + str(N) + " Heartbeats w/ Step Size of " + str(slide_step_size) , fontsize=20)
                else:
                    plt.suptitle(str(count) + " of " + str(len(composite_endpoints)) + " INO Composites for Dosage " + str(dosage) + " given " + str(N) + " Heartbeats w/ Step Size of " + str(slide_step_size) , fontsize=20)
